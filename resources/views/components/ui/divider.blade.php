<div class="flex flex-row gap-2 items-center justify-center mx-auto  my-2 sm:my-10 w-9/12">
    <hr class="w-full text-[#0594d1]  h-[2px] text-left right-0  bg-[#333] rounded-sm my-2 md:my-10">
        <svg aria-hidden="true" class="h-10 fill-[#0594d1]" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
