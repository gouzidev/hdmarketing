    ...
    <div dir="ltr" class="px-4 lg:px-10 flex justify-between items-center relative h-16 lg:h-20">
        ...
        <div id="nav-menu" class="
            ...
            @elseif (auth()->user()->is_admin)
                ...
                <a href="{{ route('admin.requests.index') }}" class="flex items-center hover:text-gray-300 transition">طلبات الانضمام للإدارة</a>
                ...
                <a href="{{ route('orders.index') }}" class="flex items-center hover:text-gray-300 transition">طلبات</a>
