    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="flex justify-between items-center mb-6">
                <form class="flex flex-row items-center justify-center gap-5 relative" action="{{ route('admin.users.search') }}" action="GET">
                    <button 
                    ...
                    <input 
                        name="search"
                        type="text" placeholder="...بحث عن مستخدمين" class="text-right pr-2 py-2  border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
