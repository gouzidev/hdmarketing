            ...
            <form action="{{ route('admin.shipping.update', $shipping) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="country" id="country" value="{{ old('country', $shipping->country) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="city" id="city" value="{{ old('city', $shipping->city) }}" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500">
                        @error('city')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="street" id="street" value="{{ old('street', $shipping->street) }}" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-yellow-500 focus:border-yellow-500">
                        @error('street')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price', $shipping->price) }}" required min="0" step="0.01"
